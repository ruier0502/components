...
scrollBar.prototype.action = function(argument){
    ...
    if(_this.getBrowserVersion() == "firefox") {
        _this.scrollContentEle.addEventListener('DOMMouseScroll', _this.mousewheel, false);
    }
    else {
        _this.scrollContentEle.onmousewheel = _this.mousewheel;
    }
    if(document.addEventListener) {
        _this.scrollBarSliderEle.addEventListener('mousedown', _this.mousedown);
    }
    else if(document.attachEvent) {
        _this.scrollBarSliderEle.attachEvent('mousedown', _this.mousedown);
    }
